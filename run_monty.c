...
/**
 * get_op_func - Matches an opcode with its corresponding fnct.
 * @opcode: opcode to match.
 * Return: pointer to the corresponding fnct.
 */
...
/**
 * run_monty - Primary fnct to execute a monty bytecodes script.
