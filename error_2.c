...
/**
 * short_stack_error - Prints monty math fnct error messages for stacks/queues smaller than 2 nodes.
 * @line_number: Line number in monty bytecodes file.
 * @op: Operation.
 * Return: EXIT_FAILURE always.
 */
...
/**
 * pchar_error - Prints pchar error messages for empty stacks & non-character values.
 * @line_number: Line number in monty bytecodes file.
